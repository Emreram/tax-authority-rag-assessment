...
1. **Open het deck:** [`assessment_AI_USE_emresemerci_v2.pptx`](assessment_AI_USE_emresemerci_v2.pptx). 19 slides over het volledige AI-werkproces, de architectuur en de werkende demo.
2. **Onderbouwingsnotities per Operations-tab:** [`slides/operations_justification.md`](slides/operations_justification.md) — vijf secties met Choice · Rejected · Trade-off per Operations-workspace in de demo. (Render naar .pptx met `python slides/build_slides.py` indien gewenst.)
...
| [`ASSESSMENT_REVIEW_FEEDBACK.md`](ASSESSMENT_REVIEW_FEEDBACK.md) | Letterlijke feedback uit de eerste assessment-ronde |
